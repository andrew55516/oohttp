...
//   $ bundle -o=h2_bundle.go -prefix=http2 -tags=!nethttpomithttp2 github.com/ooni/oohttp/http2
...
func (cc *http2ClientConn) RoundTrip(req *Request) (*Response, error) {
	...
	handleResponseHeaders := func() (*Response, error) {
		...
		res.ConnCloserFunc = func(err error) {
			cc.Close()
		}
		return res, nil
	}
...
func (cc *http2ClientConn) encodeHeaders(req *Request, addGzipHeader bool, trailers string, contentLength int64) ([]byte, error) {
	...
	enumerateHeaders := func(f func(name, value string)) {
		...
		pHeaderOrder, ok := req.Header[PseudoHeaderOrderKey]
		m := req.Method
		if m == "" {
			m = MethodGet
		}
		...
		for k := range req.Header {
			if http2asciiEqualFold(k, "accept-encoding") {
